  ...
  $(document).ready(function () {
    $('.bq1').click(function (e) {
      $('#q1').fadeOut('slow', function () {
        $('#q2').fadeIn('slow');
        answers.sex = e.target.textContent.trim();
      });
    }),
      $('.bq2').click(function (e) {
        $('#q2').fadeOut('slow', function () {
          $('#q3').fadeIn('slow');
          answers.age = e.target.textContent.trim();
        });
      }),
      $('.bq3').click(function (e) {
        $('#q3').fadeOut('slow', function () {
          $('#q4').fadeIn('slow');
          answers.familySize = e.target.textContent.trim();
        });
      }),
      $('.bq4').click(function (e) {
        answers.boughtAppleiPhoneXS = e.target.textContent.trim();
        // console.log(answers);
        scrollTo('id1'),
